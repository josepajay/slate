...
```shell
curl --request GET \
  --url http://192.168.1.200:5000/credenceapi/rootkey/generate \
...
```shell
curl --request POST \
  --url http://192.168.1.200:5000/credenceapi/ckd/publickey \
  --header 'content-type: application/json' \
...
```shell
curl --request POST \
  --url http://192.168.1.200:5000/credenceapi/transaction/create \
  --header 'content-type: application/json' \
...
`POST /credenceapi/transaction/create`
...
```shell
curl --request POST \
  --url http://192.168.1.200:5000/credenceapi/transaction/sign \
  --header 'content-type: application/json' \
...
`POST /credenceapi/transaction/sign`
...
```shell
curl --request POST \
  --url http://192.168.1.200:5000/credenceapi/transaction/verify \
  --header 'content-type: application/json' \
...
`POST /credenceapi/transaction/verify`
...
```shell
curl --request POST \
  --url http://192.168.1.200:5000/credenceapi/transaction/pack \
  --header 'content-type: application/json' \
...
`POST /credenceapi/transaction/pack`
